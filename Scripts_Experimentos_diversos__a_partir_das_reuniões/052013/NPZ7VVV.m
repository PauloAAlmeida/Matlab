...
g0 = 0.7;          % NANOZ->PICO (* tabela 2, valor de Phip - No artigo, 'g' é uma função do tipo M.Menten)
g1 = 1*1;             % NANOZ->BACT (**)
g2 = 3;              % DET->BACT (**)
g3 = 0.35/(Kn+NANOF);               % NANOZ->NANOF (* tabela 2)
g4 =  0.45/(Knz+NANOZOO) ;           % MICROZ-NANOZ (*tabela 2)
g5 = 0 *1;            % MICROZ-NANOF (*tabela 2)

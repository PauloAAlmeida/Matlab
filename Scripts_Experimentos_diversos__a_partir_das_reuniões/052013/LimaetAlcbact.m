...
function dydt = LimaetAlcbact(t,y)
...
% SISTEMA 'NPZD LimaetAl'
   ...
   dydt(6,1) =  ((1-a_z1)*g1*G_1*NANOZOO + (1-a_z2)*g2*G_2*MICROZ - g1*G_1d*NANOZOO - g2*G_2d*MICROZ + d_p0*PICO + d_p1*NANOF + d_z1*NANOZOO^2 +d_z2*MICROZ^2) + d_b*BACT - c2 * g4 * DET * BACT; %DET ;
   
   dydt(7,1) = c2 * g4 *DET * BACT - g1 * G_1b  * NANOZOO  - e * BACT - d_b * BACT; %BACT

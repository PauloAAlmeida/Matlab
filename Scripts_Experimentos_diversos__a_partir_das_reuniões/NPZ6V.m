...
g0 = 0.65;           % NANOZ->PICO (* tabela 2, valor de Phip - No artigo, 'g' é uma função do tipo M.Menten)
g1 = 1;             % NANOZ->BACT (**)
%g2 = 1;                % DET->BACT (**)
...
c0 = 0.8*0.25;           % NANOZ - tx de conversão do PICO em NANOZ (* tabela 1)
c1 = 0.2;            % NANOZ - tx de conversão da BACT em NANOZ (**)
c2 = 1;             % BACT - tx de conversão do detrito em BACT (**)
c3 = 0.8*0.25;              % NANOZ - tx de conversão do NANOF em NANOZ (*** tabela 1)

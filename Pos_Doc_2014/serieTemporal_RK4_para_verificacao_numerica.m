    function serieTemporal_RK4_para_verificacao_numerica()
...
%metodo RK4-alterar nome da função e numero de variáveis (n, lá em
%cima)entre Sist.Lima e Sist.NPPZZDB1
for i=1:length(t)-1 
